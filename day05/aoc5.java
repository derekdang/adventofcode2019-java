        ...
        for (int i = 0; !split[i].equals("99");) {
            ...
            switch (op) {
                ...
                case "2":
                    ...
                    break;
                case "3":
                    split[destination] = String.valueOf(val);
                    i += 2;
                    break;
                case "4":
